...
//less complicated version, more closely aligned to assignment
function Photo(name, url) {
	this.name = name;
	this.url = url;
}
...
var Aimee = new Teacher("Aimee", "Kerrigan", "Math");
var Jackie = new Teacher("Jackie", "Sulzer", "English");
var Dawn = new Teacher("Dawn", "Levy", "Library");

var Erynn = new Student("Erynn", "Butler", 10);
var Heather = new Student("Heather", "Butler", 8);
var Rhys = new Student("Rhys", "Monday", 1);

var hogwarts = new School;

hogwarts.addStudent(Erynn);
hogwarts.addStudent(Heather);
hogwarts.addStudent(Rhys);

hogwarts.addTeacher(Aimee);
hogwarts.addTeacher(Jackie);
hogwarts.addTeacher(Dawn);
